...
IMPORTANT: In this project, Zookeeper was not used as Kafka > 3.2 supports internal clustering with KRaft for production environments.
...
== Test Environment
This project was rigorously tested on a MacBook Pro with an Apple M2 Max chip, 32 GB RAM under macOS Sonoma 14.2.1, Docker Desktop 4.27.2, and Kubernetes v1.29.1.
